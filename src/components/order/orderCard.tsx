...
const OrderCard = () => {
  return (
    <Card className="max-w-[290px] flex- h-fit rounded-md ">
      <CardHeader className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          ...
          <div className="">
            ...
            <CardDescription className="text-[13px]">12:30 PM</CardDescription>
          </div>
        </div>
      ...
      <CardContent className="px-">
        <div className="flex items-center justify-between w-[94%]">
          ...
          <div>
            <h3 className="font-medium text-muted-foreground">Total Payment</h3>
        ...
        <div className="mt-4 px">
          <span className="font-medium text-muted-foreground">Order Notes</span>
